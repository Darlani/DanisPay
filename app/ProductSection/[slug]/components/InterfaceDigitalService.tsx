    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-6">
        <section className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
          <h2 className="font-black text-xl italic mb-6 text-slate-800">{t("products.minor.digitalServiceConfig")}</h2>
        ...
        <section className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
           <h2 className="font-black text-xl italic mb-4 text-slate-800">{t("products.minor.digitalTargetDetails")}</h2>
           <label className="text-[10px] font-black uppercase text-slate-400 ml-2 mb-1 block">{t("products.minor.digitalTargetLabel")}</label>
           <div className="relative">
             ...
             <input
                ...
                placeholder={t("products.minor.digitalTargetPlaceholder")}

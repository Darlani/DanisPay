...
Checkpoint diperbarui: **2026-09-09**  
Status saat ini: **MASTER CHECKPOINT seluruh proyek DaPay. Withdrawal, deposit, shared payment, dan MacroDroid milestone yang tercatat di bawah sudah diverifikasi sesuai scope masing-masing; Marketing Sandbox Batch 1A database foundation sudah selesai, dideploy ke Supabase production, dan diverifikasi independen PASS; Batch 1A CLOSED / PASS, Batch 1B application wiring belum dimulai; security audit selanjutnya sedang dipause atas keputusan user. Deployment aplikasi ke VPS tetap tunduk pada deployment policy yang berlaku dan bukan next step.**  
...
# 19. MILESTONE — MARKETING SANDBOX BATCH 1A

**STATUS: SELESAI / TERVERIFIKASI / PRODUCTION PASS**

Tanggal checkpoint: **2026-09-09**

## 19.1 Migration

Migration yang dibuat dan dideploy:
```text
supabase/migrations/20260909100000_marketing_sandbox_access_and_conversion.sql
```
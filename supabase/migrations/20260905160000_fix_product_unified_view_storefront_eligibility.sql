-- Migration: 20260905160000_fix_product_unified_view_storefront_eligibility.sql
-- Description: Fix product_automatic storefront eligibility in product_unified_view to check both multi-provider mapping and direct canonical provider
